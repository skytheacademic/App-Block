...
- Tests: `./gradlew testDebugUnitTest --rerun` — pass `--rerun`, because an up-to-date run reports success without executing anything. 554 JVM tests (engine + Robolectric screens/stores/workers) at the time of writing.
